...
_Last updated: 2026-06-24 (deep scan v6.5.1 → v7.2.1: 22 releases, 97 commits). Net: 1 new security GAP (DNS-rebinding → SEC-13); 2 PARTIALs (FUGR structural-include CRUD; cert/Kerberos auth — both low/med, deferred); SearchSource + 423 lock confirmed ALREADY-HAVE; v5.2.0 odatav4 publish bug now Done (PR #130)._
