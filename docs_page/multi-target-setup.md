...
- an SAP Cloud Connector mapping for every on-premise target, including the required ADT resource
  paths from the [Cloud Connector URL path reference](btp-destination-setup.md#cloud-connector-url-path-reference);
