...
Before changing trust or mapping, fill the [shared setup worksheet](btp-setup-worksheet.md) with
the connector, Basis and IAM owners. It records the intended system/client and backend user
separately from the application email and CLI identity.
