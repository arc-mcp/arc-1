...
|------|------|
| BTP deployment/docs guidance | `docs/btp-setup-index.yaml` → matching canonical guide; `docs_page/btp-documentation.md` explains source/status. Select deployed artifact and topology first; proposals are not shipped settings, and unresolved CF/IAM/Basis ownership must be reported. |
