...
| `ARC1_SYSTEM_LABEL` / `--system-label` | Free-text connected-system label (default empty), prepended to the MCP server instructions — identifies the instance even behind opaque connector ids; ignored in multi-target mode |
