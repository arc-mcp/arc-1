...
import { decodeKtdText, normalizeAdtLanguage, rewriteKtdText } from '../adt/ddic-xml.js';
import {
  activate,
  activateBatch,
...
import type { AdtObjectLookupResult, AdtSearchResult, ClassStructure, InactiveObject } from '../adt/types.js';
...
import { cachedFeatures, isBtpSystem, isTablesEndpointAvailable } from './feature-cache.js';
