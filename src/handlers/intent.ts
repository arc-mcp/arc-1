...
import type { AdtObjectLookupResult, AdtSearchResult, ClassStructure } from '../adt/types.js';
...
import {
  buildCacheSecurityContext,
  type CacheSecurityContext,
  invalidateInactiveList,
...
import { handleSAPRead, resolveVersionAndDraftInfo, type SourceVersion } from './read.js';
