        ...
        properties: {
          ...
          grep: {
            ...
            description:
              ...
              'Works for source-bearing types (CLAS, INTF, DDLS, DCLS, BDEF, SRVD, DDLX, TABL' +
              (btp ? '' : ', PROG, FUNC, INCL, VIEW') +
