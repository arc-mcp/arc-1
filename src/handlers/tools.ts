      ...
      inputSchema: {
        ...
        properties: {
          ...
          version: {
            ...
            description:
              'Source defaults active; inactive requests a draft (SAP may return active if none); auto selects developer view. DTEL/server-driven types default to developer view. Server-driven types return an error if SAP cannot confirm an explicit version.',
          },
          includeSignature: {
            type: 'boolean',
            description:
