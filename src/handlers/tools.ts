      ...
      inputSchema: makeOptionalPropertiesNullable({
        ...
        properties: {
          ...
          refObjectType: {
            type: 'string',
            description:
              'SKTD/KTD create: ADT type+subtype of the parent object the KTD documents (e.g., "DDLS/DF", "CLAS/OC", "INTF/OI", "PROG/P", "BDEF/BDO", "SRVD/SRV"). Required for SKTD/KTD create.',
          },
          refObjectName: {
            type: 'string',
