      ...
      properties: {
        action: {
          ...
          description:
            ...
            '"usages" = live SAP reverse dependency lookup — "who calls <object>?". Provide "type" when known; when omitted, the name must resolve to exactly one SAP object. For CDS entities prefer action="impact" instead.\n' +
