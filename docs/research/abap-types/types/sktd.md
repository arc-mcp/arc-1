...
- `docs/compare/00-feature-matrix.md:108` and `:138` and `:302`/`:347`: ARC-1 is the **only**
...
- Observed object: `ZARC1SKTDMO1FSEY21IL3`; GET `/sap/bc/adt/documentation/ktd/documents/zarc1sktdmo1fsey21il3`.
- Recorded: 2026-09-09T23:02:36.586Z; metadata QName: `sktd:docu`.
- [Sanitized wire fixture](../../../../tests/fixtures/relations/sktd-typ.json) also preserves one observed ENV edge and original-body SHA-256 values. It is a projection, not a complete network.

```xml
<sktd:docu adtcore:name="ZARC1SKTDMO1FSEY21IL3" adtcore:type="SKTD/TYP" adtcore:version="active" xmlns:sktd="http://www.sap.com/wbobj/texts/sktd" xmlns:adtcore="http://www.sap.com/adt/core">
