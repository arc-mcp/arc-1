...
> compare matrix row "SQL traces" (`compare/00-feature-matrix.md:221`). True standalone ST05 has **no ADT
...
(`docs/nw750-discovery-gap-analysis.md:52-53`); confirmed live on 758 below. Eclipse bundle
