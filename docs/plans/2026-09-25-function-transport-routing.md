...
Namespaced group decoding and locked-result parsing have deterministic unit coverage;
no live occupied transport or PP identity was used. This is routing coverage, not
