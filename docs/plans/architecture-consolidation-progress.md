...
- [x] **F** verification gate — green through Stage D: `npm test` (110 files / 3,718 tests), typecheck, lint, validate:policy, build, check:sizes all pass; A1 snapshots byte-identical.
