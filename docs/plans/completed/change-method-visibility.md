...
- [ ] `compare/00-feature-matrix.md`: append a dated note that `change_method_visibility` landed (token-efficient, body-preserving visibility move) + bump the existing surgery line; `docs_page/roadmap.md`: extend the Method-Level Surgery row.
...
- [ ] Move this plan to `docs/plans/completed/change-method-visibility.md`
