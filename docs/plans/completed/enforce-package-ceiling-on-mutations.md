...
- Modify: `docs/research/security-audit-2026-06-oauth-and-scope.md`
...
- [ ] Append a short "Package-ceiling enforcement on activation & change_package" note to
  `docs/research/security-audit-2026-06-oauth-and-scope.md` summarizing the two findings and the fix
