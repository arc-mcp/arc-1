...
| `docs/research/test-runtime-profiles-and-coverage-2026-06-06.md` | Existing runtime follow-up that calls out the 2025 GitHub migration as open. |
| `docs/research/github-actions-a4h-2025-migration-2026-06-06.md` | New checkpoint document for this migration. |
...
- Create: `docs/research/github-actions-a4h-2025-migration-2026-06-06.md`
...
- Modify: `docs/research/test-runtime-profiles-and-coverage-2026-06-06.md`
- Move: `docs/plans/github-actions-a4h-2025-migration.md` to `docs/plans/completed/github-actions-a4h-2025-migration.md`
