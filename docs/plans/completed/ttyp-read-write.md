...
`docs/research/adt-transaction-source-write.md`). There is no backend on any available test system to
...
- [ ] Add the TTYP rows/cases as above. `objectBasePath('TTYP')` returns `/sap/bc/adt/ddic/tabletypes/`
      ...
      (create `research/abap-types/types/ttyp.md` noting the live `adtcore:type="TTYP/DA"`).
...
- Modify: `docs_page/tools.md` (SAPRead/SAPWrite TTYP), `AGENTS.md` Key-Files row, `docs/research/adt-transaction-source-write.md` (note: endpoint still 404 on 758+816 — TRAN deferred)
