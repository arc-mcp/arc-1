...
| `docs_page/tools.md`, `CLAUDE.md`, `README.md`, `compare/00-feature-matrix.md`, `docs_page/roadmap.md` | Documentation. |
...
- [ ] `compare/00-feature-matrix.md`: add a row under the ABAP Read Operations section (~after line 142) for "Grep/regex search within source" and refresh the "Last updated" line (~line 5).
