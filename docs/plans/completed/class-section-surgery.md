...
| `compare/00-feature-matrix.md` | New "Class-section surgery" capability row (or extend existing "EditSource (surgical)" row). Bump "Last Updated". |
...
- [ ] Move this plan: `mv docs/plans/class-section-surgery.md docs/plans/completed/class-section-surgery.md`
