...
- `compare/00-feature-matrix.md` — refreshed `_Last updated:_`, NEW §4.1 "Supply-Chain Security" sub-table with 10 controls × 9 projects (ARC-1 leads ✅; competitor scores spot-checked via `gh api`).
