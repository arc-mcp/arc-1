...
| `docs/research/test-runtime-profiles-and-coverage-2026-06-06.md` | Runtime research checkpoint to update with manual slow workflow status and baseline. |
| `docs/research/github-actions-a4h-2025-migration-2026-06-06.md` | GitHub secret migration research to update with the old-secret audit result. |
...
- [x] Run `rg -n "manual slow|SAP Slow|transport release|lock/unlock" docs/research/test-runtime-profiles-and-coverage-2026-06-06.md docs/integration-test-skips.md` to confirm the new guidance is discoverable.

### Task 4: Update GitHub secret audit documentation

**Files:**
- Modify: `docs/research/github-actions-a4h-2025-migration-2026-06-06.md`
