...
| Add/modify npm audit / SAST / dep review CI gate | `.github/workflows/dependency-review.yml` (security and licenses separate), `.github/security-ruleset.json` (disabled template; only dependency security + CodeQL security), `.github/workflows/test.yml` (existing full-tree audit). Activation and release-App prerequisites: `docs/security-operations.md`. |
